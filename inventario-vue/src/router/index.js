...
const routes = [
  ...
  { path: '/tesoreria/procesos/ventas-vivo',                     component: () => import('../views/tesoreria/VentasVivoView.vue'),                meta: { requiresAuth: true } },
  ...
  { path: '/gerencia/reportes/composicion-ventas', component: () => import('../views/gerencia/GerenciaComposicionVentasView.vue'), meta: { requiresAuth: true } },
