    ...
    <div class="oc-container">
      ...
      <div class="kpi-row">
        ...
        <div class="kpi-card">
          ...
          <div>
            <div class="kpi-val">{{ kpiEnReparto }}</div>
            <div class="kpi-lbl">En Reparto</div>
          </div>
        </div>
        <div class="kpi-card">
...
const kpiEnReparto   = computed(() => ordenes.value.filter(o => o.estado === 'EN REPARTO').length)
...
function chipClass(estado) {
  ...
  if (estado === 'EN REPARTO') return 'chip-autorizada'
