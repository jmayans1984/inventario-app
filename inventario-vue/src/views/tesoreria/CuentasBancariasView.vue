  ...
  <MainLayout>
    <div class="view-container">
      <div class="breadcrumb">
        ...
        <v-icon size="13" class="bc-sep">mdi-chevron-right</v-icon>
        <span class="bc-current">Cuentas Bancarias</span>
      </div>
      <div class="page-header">
        <div class="header-left">
          ...
          <div>
            ...
            <p class="page-sub">Administra las cuentas bancarias de la empresa</p>
          </div>
        </div>
        <v-btn class="btn-nuevo" prepend-icon="mdi-plus">Nueva Cuenta</v-btn>
      </div>
      <div class="wip-card">
        <v-icon size="56" class="wip-icon">mdi-bank-outline</v-icon>
        <h2 class="wip-title">Módulo en Desarrollo</h2>
        <p class="wip-sub">La gestión de cuentas bancarias estará disponible próximamente.</p>
        <v-chip color="teal" variant="tonal" size="small" class="mt-4">TESORERÍA · Configuración</v-chip>
      </div>
    </div>
  </MainLayout>
</template>
