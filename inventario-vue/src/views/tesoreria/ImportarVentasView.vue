<template>
  <MainLayout>
    <div class="view-container">
      <div class="breadcrumb"><span class="bc-root">TESORERÍA</span><v-icon size="13" class="bc-sep">mdi-chevron-right</v-icon><span class="bc-cat">Procesos</span><v-icon size="13" class="bc-sep">mdi-chevron-right</v-icon><span class="bc-current">Importar Ventas</span></div>
      <div class="page-header"><div class="header-left"><div class="header-icon-wrap"><v-icon size="22" color="white">mdi-file-import-outline</v-icon></div><div><h1 class="page-title">IMPORTAR VENTAS</h1><p class="page-sub">Importa registros de ventas desde archivos externos</p></div></div><v-btn class="btn-nuevo" prepend-icon="mdi-upload">Importar Archivo</v-btn></div>
      <div class="wip-card"><v-icon size="56" class="wip-icon">mdi-file-import-outline</v-icon><h2 class="wip-title">Módulo en Desarrollo</h2><p class="wip-sub">La importación de ventas estará disponible próximamente.</p><v-chip color="teal" variant="tonal" size="small" class="mt-4">TESORERÍA · Procesos</v-chip></div>
    </div>
  </MainLayout>
</template>
