      ...
      <div class="page-header">
        <div class="header-left">
          ...
          <div>
            ...
            <p class="page-sub">Importa registros de ventas desde archivos externos</p>
          </div>
        </div>
        <v-btn class="btn-nuevo" prepend-icon="mdi-upload">Importar Archivo</v-btn>
      </div>
      <div class="wip-card">
        <v-icon size="56" class="wip-icon">mdi-file-import-outline</v-icon>
        <h2 class="wip-title">Módulo en Desarrollo</h2>
        <p class="wip-sub">La importación de ventas estará disponible próximamente.</p>
