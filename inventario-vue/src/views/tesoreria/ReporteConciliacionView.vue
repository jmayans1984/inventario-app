      ...
      <div class="page-header">
        <div class="header-left">
          ...
          <div>
            ...
            <p class="page-sub">Reporte de conciliación entre movimientos bancarios y contables</p>
          </div>
        </div>
        <v-btn class="btn-nuevo" prepend-icon="mdi-file-pdf-box">Generar PDF</v-btn>
      </div>
      <div class="wip-card">
        <v-icon size="56" class="wip-icon">mdi-file-chart-outline</v-icon>
        <h2 class="wip-title">Módulo en Desarrollo</h2>
        <p class="wip-sub">El reporte de conciliación bancaria estará disponible próximamente.</p>
