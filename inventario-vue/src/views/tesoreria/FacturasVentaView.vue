      ...
      <div class="page-header">
        <div class="header-left">
          ...
          <div>
            ...
            <p class="page-sub">Gestiona las facturas de venta emitidas</p>
          </div>
        </div>
        <v-btn class="btn-nuevo" prepend-icon="mdi-plus">Nueva Factura</v-btn>
      </div>
      <div class="wip-card">
        <v-icon size="56" class="wip-icon">mdi-receipt-outline</v-icon>
        <h2 class="wip-title">Módulo en Desarrollo</h2>
        <p class="wip-sub">Las facturas de venta estarán disponibles próximamente.</p>
