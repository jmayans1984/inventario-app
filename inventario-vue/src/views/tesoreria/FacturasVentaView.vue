<template>
  <MainLayout>
    <div class="view-container">
      <div class="breadcrumb"><span class="bc-root">TESORERÍA</span><v-icon size="13" class="bc-sep">mdi-chevron-right</v-icon><span class="bc-cat">Procesos</span><v-icon size="13" class="bc-sep">mdi-chevron-right</v-icon><span class="bc-current">Facturas de Venta</span></div>
      <div class="page-header"><div class="header-left"><div class="header-icon-wrap"><v-icon size="22" color="white">mdi-receipt-outline</v-icon></div><div><h1 class="page-title">FACTURAS DE VENTA</h1><p class="page-sub">Gestiona las facturas de venta emitidas</p></div></div><v-btn class="btn-nuevo" prepend-icon="mdi-plus">Nueva Factura</v-btn></div>
      <div class="wip-card"><v-icon size="56" class="wip-icon">mdi-receipt-outline</v-icon><h2 class="wip-title">Módulo en Desarrollo</h2><p class="wip-sub">Las facturas de venta estarán disponibles próximamente.</p><v-chip color="teal" variant="tonal" size="small" class="mt-4">TESORERÍA · Procesos</v-chip></div>
    </div>
  </MainLayout>
</template>
