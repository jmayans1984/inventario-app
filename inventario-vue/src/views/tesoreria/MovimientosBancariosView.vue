<template>
  <MainLayout>
    <div class="view-container">
      <div class="breadcrumb"><span class="bc-root">TESORERÍA</span><v-icon size="13" class="bc-sep">mdi-chevron-right</v-icon><span class="bc-cat">Procesos</span><v-icon size="13" class="bc-sep">mdi-chevron-right</v-icon><span class="bc-current">Movimientos Bancarios</span></div>
      <div class="page-header"><div class="header-left"><div class="header-icon-wrap"><v-icon size="22" color="white">mdi-swap-horizontal</v-icon></div><div><h1 class="page-title">MOVIMIENTOS BANCARIOS</h1><p class="page-sub">Registra y consulta movimientos en cuentas bancarias</p></div></div><v-btn class="btn-nuevo" prepend-icon="mdi-plus">Nuevo Movimiento</v-btn></div>
      <div class="wip-card"><v-icon size="56" class="wip-icon">mdi-swap-horizontal</v-icon><h2 class="wip-title">Módulo en Desarrollo</h2><p class="wip-sub">Los movimientos bancarios estarán disponibles próximamente.</p><v-chip color="teal" variant="tonal" size="small" class="mt-4">TESORERÍA · Procesos</v-chip></div>
    </div>
  </MainLayout>
</template>
