<template>
  <MainLayout>
    <div class="view-container">
      <div class="breadcrumb"><span class="bc-root">TESORERÍA</span><v-icon size="13" class="bc-sep">mdi-chevron-right</v-icon><span class="bc-cat">Reportes</span><v-icon size="13" class="bc-sep">mdi-chevron-right</v-icon><span class="bc-current">Ventas de Productos por Período</span></div>
      <div class="page-header"><div class="header-left"><div class="header-icon-wrap"><v-icon size="22" color="white">mdi-package-variant-closed</v-icon></div><div><h1 class="page-title">VENTAS DE PRODUCTOS POR PERÍODO</h1><p class="page-sub">Detalle de ventas desglosado por producto y período</p></div></div><v-btn class="btn-nuevo" prepend-icon="mdi-file-pdf-box">Generar PDF</v-btn></div>
      <div class="wip-card"><v-icon size="56" class="wip-icon">mdi-package-variant-closed</v-icon><h2 class="wip-title">Módulo en Desarrollo</h2><p class="wip-sub">El reporte de ventas de productos por período estará disponible próximamente.</p><v-chip color="teal" variant="tonal" size="small" class="mt-4">TESORERÍA · Reportes</v-chip></div>
    </div>
  </MainLayout>
</template>
