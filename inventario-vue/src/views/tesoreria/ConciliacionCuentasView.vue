      ...
      <div class="page-header">
        <div class="header-left">
          ...
          <div>
            ...
            <p class="page-sub">Concilia movimientos bancarios con registros contables</p>
          </div>
        </div>
        <v-btn class="btn-nuevo" prepend-icon="mdi-plus">Nueva Conciliación</v-btn>
      </div>
      <div class="wip-card">
        <v-icon size="56" class="wip-icon">mdi-bank-check</v-icon>
        <h2 class="wip-title">Módulo en Desarrollo</h2>
        <p class="wip-sub">La conciliación de cuentas estará disponible próximamente.</p>
