  ...
  },
  {
    ...
    children: [
      { name: 'Configuración', icon: 'mdi-cog-outline', items: [
        ...
        { name: 'Artículos ↔ Productos', icon: 'mdi-swap-horizontal-bold', path: '/almacen/configuracion/mapeo-articulo-producto' },
        { name: 'Presentaciones de Compra', icon: 'mdi-package-variant-closed', path: '/almacen/configuracion/presentaciones-compra' },
      ]},
      { name: 'Procesos', icon: 'mdi-cogs', items: [
        ...
        { name: 'Órdenes de Compra', icon: 'mdi-clipboard-list-outline', path: '/almacen/procesos/ordenes-compra', requiredTipo: 'CLIENTE' },
      ...
      { name: 'Reportes', icon: 'mdi-chart-bar', items: [
        ...
        { name: 'Consumo de Productos', icon: 'mdi-package-down', path: '/almacen/reportes/consumo-insumos' },
  ...
  },
  {
    ...
    children: [
      { name: 'Reportes', icon: 'mdi-chart-bar', items: [
        ...
        { name: 'Composición de Ventas', icon: 'mdi-chart-donut-variant',   path: '/gerencia/reportes/composicion-ventas' },
        ...
        { name: 'Ingeniería de Menú',   icon: 'mdi-silverware-fork-knife',  path: '/gerencia/reportes/ingenieria-menu' },
