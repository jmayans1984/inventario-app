import{t as e,v as t}from"./VBtn.js";import{c as n,o as r,t as i,x as a}from"./MainLayout.js";import{An as o,Dn as s,Gt as c,Kn as l,Kt as u,Ln as d,Xt as f,Yn as p,an as m,c as h,en as g,gn as ee,i as te,in as _,kn as v,nn as ne,on as y,rn as b,s as re,tn as x,xn as S,yn as C}from"./index.js";import{t as w}from"./VIcon.js";import{t as ie}from"./PageHeader.js";var ae={class:`pg-container`},oe={class:`toolbar`},se={class:`search-wrap`},ce={class:`count-badge`},le={class:`tabla-card`},ue={key:0,class:`loading-wrap`},de={key:1,class:`crud-table`},fe={key:0},pe={colspan:`6`,class:`empty-row`},me={class:`cod-badge`},he={class:`fw500`},ge={class:`col-center`},_e={class:`col-center`},ve={class:`col-acc`},ye={class:`modal-header`},be={class:`modal-body`},xe={class:`field-group`},Se={class:`cod-wrap`},Ce=[`disabled`],we={class:`cod-hint`},Te={key:0,class:`error-txt`},T={class:`field-group`},E=[`value`],D={key:0,class:`error-txt`},O={class:`form-row-2`},Ee={class:`field-group`},De={key:0,class:`error-txt`},Oe={class:`field-group`},ke={key:0,class:`hint-txt`},Ae={class:`field-group`},je=[`value`],Me={class:`field-group`},Ne={key:0,class:`api-error`},Pe={class:`modal-footer`},k=te({__name:`LotesFabricacionView`,setup(te){let k=re(),A=g(()=>k.empresaCodigo),j=d([]),M=d([]),N=d([]),P=d(``),F=d(`6x4`),I=d(!1),L=d(!1),R=d(null),z=d(!1),B=d(!1),V=d(``),H=d({}),U=()=>({codigo:``,etiqueta:``,fecha_fab:new Date().toISOString().split(`T`)[0],fecha_vence:``,responsable:``,observaciones:``}),W=d(U()),G=new Date,K=g(()=>`${String(G.getMonth()+1).padStart(2,`0`)}${String(G.getDate()).padStart(2,`0`)}${String(G.getFullYear()).slice(-2)}001`),q=g(()=>!W.value.etiqueta||!W.value.fecha_fab?null:M.value.find(e=>e.codigo===W.value.etiqueta)?.dias_vencimiento||null),J=g(()=>{if(!q.value||!W.value.fecha_fab)return``;let e=new Date(W.value.fecha_fab+`T12:00:00`);return e.setDate(e.getDate()+q.value),e.toISOString().split(`T`)[0]});s([()=>W.value.etiqueta,()=>W.value.fecha_fab],()=>{J.value&&(W.value.fecha_vence=J.value)});let Y=g(()=>{let e=P.value.toLowerCase();return j.value.filter(t=>t.codigo.toLowerCase().includes(e)||(t.etiqueta_nombre||``).toLowerCase().includes(e)||(t.etiqueta||``).toLowerCase().includes(e)||(t.responsable||``).toLowerCase().includes(e))});function X(e){return e?new Date(String(e).substring(0,10)+`T12:00:00`).toLocaleDateString(`es`,{day:`2-digit`,month:`short`,year:`numeric`}):`—`}function Z(e){if(!e)return!1;let t=(new Date(String(e).substring(0,10)+`T12:00:00`)-new Date)/(1e3*60*60*24);return t>=0&&t<=7}async function Fe(){I.value=!0;try{let[e,t,n,r]=await Promise.all([fetch(`${h}/almacen/lotes-fabricacion?empresa=${A.value}`).then(e=>e.json()),fetch(`${h}/almacen/etiquetas-producto?empresa=${A.value}`).then(e=>e.json()),fetch(`${h}/nomina/empleados-basico?empresa=${A.value}`).then(e=>e.json()),fetch(`${h}/empresas/formato-etiqueta-produccion?empresa=${A.value}`).then(e=>e.json())]);j.value=e.data||[],M.value=t.data||[],N.value=n.data||[],F.value=r.data?.formato_etiqueta_produccion||`6x4`}catch(e){console.error(e)}finally{I.value=!1}}async function Q(){try{return(await(await fetch(`https://inventario-app-production-e8c8.up.railway.app/api/almacen/lotes-fabricacion/proximo-codigo`)).json()).codigo||K.value}catch{return K.value}}async function $(e=null){if(H.value={},V.value=``,B.value=!!e,e)W.value={codigo:e.codigo,etiqueta:e.etiqueta,fecha_fab:String(e.fecha_fab).substring(0,10),fecha_vence:e.fecha_vence?String(e.fecha_vence).substring(0,10):``,responsable:e.responsable||``,observaciones:e.observaciones||``};else{let e=await Q();W.value={...U(),codigo:e}}z.value=!0}function Ie(){let e={};return W.value.codigo.trim()||(e.codigo=`Requerido`),W.value.etiqueta||(e.etiqueta=`Requerido`),W.value.fecha_fab||(e.fecha_fab=`Requerido`),H.value=e,Object.keys(e).length===0}async function Le(){if(Ie()){L.value=!0,V.value=``;try{let e=B.value?`${h}/almacen/lotes-fabricacion/${W.value.codigo}`:`${h}/almacen/lotes-fabricacion`,t=await(await fetch(e,{method:B.value?`PUT`:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(W.value)})).json();if(!t.success)throw Error(t.error);if(B.value){let e=j.value.findIndex(e=>e.codigo===W.value.codigo);e>=0&&(j.value[e]=t.data)}else j.value.unshift(t.data);z.value=!1}catch(e){V.value=e.message}finally{L.value=!1}}}async function Re(e){R.value=e.codigo;try{let t=await(await fetch(`${h}/almacen/lotes-fabricacion/${e.codigo}`,{method:`DELETE`})).json();if(!t.success)throw Error(t.error);j.value=j.value.filter(t=>t.codigo!==e.codigo)}catch(e){alert(e.message)}finally{R.value=null}}function ze(e){let t=k.empresaNombre||``,n=e=>e?new Date(String(e).substring(0,10)+`T12:00:00`).toLocaleDateString(`es`,{day:`2-digit`,month:`2-digit`,year:`numeric`}):`—`,r=e.barcode||e.codigo,i=F.value===`3x4`,a=i?32:45,o=i?1.3:1.8,s=i?`
...
<\/script>
</body></html>`,l=window.open(``,`_blank`);l.document.write(c),l.document.close()}return ee(Fe),(s,d)=>(C(),ne(i,null,{default:v(()=>[x(`div`,ae,[y(ie,{title:`Lotes de Fabricación`,description:`Lotes de fabricación por etiqueta de producto`,crumbs:[`Almacén`,`Procesos`,`Lotes de Fabricación`]},{actions:v(()=>[y(e,{color:`success`,variant:`flat`,"prepend-icon":`mdi-plus`,onClick:d[0]||=e=>$()},{default:v(()=>[...d[11]||=[m(` Nuevo Lote `,-1)]]),_:1})]),_:1}),x(`div`,oe,[x(`div`,se,[y(w,{size:`17`,color:`rgba(var(--v-theme-on-surface),.4)`},{default:v(()=>[...d[12]||=[m(`mdi-magnify`,-1)]]),_:1}),o(x(`input`,{"onUpdate:modelValue":d[1]||=e=>P.value=e,type:`text`,placeholder:`Buscar por código, etiqueta o responsable...`,class:`search-input`},null,512),[[u,P.value]])]),x(`span`,ce,p(Y.value.length)+` lotes`,1)]),x(`div`,le,[I.value?(C(),_(`div`,ue,[y(t,{indeterminate:``,color:`success`,size:`36`})])):(C(),_(`table`,de,[d[15]||=x(`thead`,null,[x(`tr`,null,[x(`th`,null,`CÓDIGO LOTE`),x(`th`,null,`PRODUCTO`),x(`th`,{class:`col-center`},`FECHA FABRICACIÓN`),x(`th`,{class:`col-center`},`FECHA VENCIMIENTO`),x(`th`,null,`RESPONSABLE`),x(`th`,{class:`col-acc`},`ACCIONES`)])],-1),x(`tbody`,null,[Y.value.length===0?(C(),_(`tr`,fe,[x(`td`,pe,[y(w,{size:`40`,color:`rgba(var(--v-theme-on-surface),.15)`},{default:v(()=>[...d[13]||=[m(`mdi-factory`,-1)]]),_:1}),d[14]||=x(`p`,null,`No hay lotes registrados`,-1)])])):b(``,!0),(C(!0),_(f,null,S(Y.value,t=>(C(),_(`tr`,{key:t.codigo,class:`data-row`},[x(`td`,null,[x(`span`,me,p(t.codigo),1)]),x(`td`,he,p(t.etiqueta_nombre||`—`),1),x(`td`,ge,p(X(t.fecha_fab)),1),x(`td`,_e,[x(`span`,{class:l(Z(t.fecha_vence)?`chip-warn`:``)},p(X(t.fecha_vence)),3)]),x(`td`,null,p(t.responsable||`—`),1),x(`td`,ve,[y(e,{icon:`mdi-printer-outline`,size:`x-small`,variant:`text`,color:`success`,onClick:e=>ze(t)},null,8,[`onClick`]),y(e,{icon:`mdi-pencil-outline`,size:`x-small`,variant:`text`,color:`primary`,onClick:e=>$(t)},null,8,[`onClick`]),y(e,{icon:`mdi-delete-outline`,size:`x-small`,variant:`text`,color:`error`,loading:R.value===t.codigo,onClick:e=>Re(t)},null,8,[`loading`,`onClick`])])]))),128))])]))]),y(n,{modelValue:z.value,"onUpdate:modelValue":d[10]||=e=>z.value=e,"max-width":`560`},{default:v(()=>[y(a,{class:`modal-card`},{default:v(()=>[x(`div`,ye,[y(w,{color:`success`,class:`mr-2`},{default:v(()=>[...d[16]||=[m(`mdi-factory`,-1)]]),_:1}),x(`span`,null,p(B.value?`Editar Lote`:`Nuevo Lote de Fabricación`),1),y(r),y(e,{icon:`mdi-close`,size:`small`,variant:`text`,onClick:d[2]||=e=>z.value=!1})]),x(`div`,be,[x(`div`,xe,[d[17]||=x(`label`,{class:`field-label`},`Código de Lote`,-1),x(`div`,Se,[o(x(`input`,{"onUpdate:modelValue":d[3]||=e=>W.value.codigo=e,disabled:B.value,type:`text`,maxlength:`20`,class:l([`field-input cod-input`,{"field-error":H.value.codigo}])},null,10,Ce),[[u,W.value.codigo]]),x(`span`,we,`Formato: MMDDAAXXX (ej. `+p(K.value)+`)`,1)]),H.value.codigo?(C(),_(`span`,Te,p(H.value.codigo),1)):b(``,!0)]),x(`div`,T,[d[19]||=x(`label`,{class:`field-label`},`Producto *`,-1),o(x(`select`,{"onUpdate:modelValue":d[4]||=e=>W.value.etiqueta=e,class:l([`field-input field-select`,{"field-error":H.value.etiqueta}])},[d[18]||=x(`option`,{value:``},`— Seleccionar —`,-1),(C(!0),_(f,null,S(M.value,e=>(C(),_(`option`,{key:e.codigo,value:e.codigo},p(e.codigo)+` — `+p(e.producto),9,E))),128))],2),[[c,W.value.etiqueta]]),H.value.etiqueta?(C(),_(`span`,D,p(H.value.etiqueta),1)):b(``,!0)]),x(`div`,O,[x(`div`,Ee,[d[20]||=x(`label`,{class:`field-label`},`Fecha de Fabricación *`,-1),o(x(`input`,{"onUpdate:modelValue":d[5]||=e=>W.value.fecha_fab=e,type:`date`,class:l([`field-input`,{"field-error":H.value.fecha_fab}])},null,2),[[u,W.value.fecha_fab]]),H.value.fecha_fab?(C(),_(`span`,De,p(H.value.fecha_fab),1)):b(``,!0)]),x(`div`,Oe,[d[21]||=x(`label`,{class:`field-label`},`Fecha de Vencimiento`,-1),o(x(`input`,{"onUpdate:modelValue":d[6]||=e=>W.value.fecha_vence=e,type:`date`,class:`field-input`},null,512),[[u,W.value.fecha_vence]]),q.value?(C(),_(`span`,ke,` Sugerido: `+p(J.value)+` (`+p(q.value)+` días) `,1)):b(``,!0)])]),x(`div`,Ae,[d[23]||=x(`label`,{class:`field-label`},`Responsable`,-1),o(x(`select`,{"onUpdate:modelValue":d[7]||=e=>W.value.responsable=e,class:`field-input field-select`},[d[22]||=x(`option`,{value:``},`— Seleccionar —`,-1),(C(!0),_(f,null,S(N.value,e=>(C(),_(`option`,{key:e.id,value:`${e.nombre} ${e.apellido}`},p(e.nombre)+` `+p(e.apellido),9,je))),128))],512),[[c,W.value.responsable]])]),x(`div`,Me,[d[24]||=x(`label`,{class:`field-label`},`Observaciones`,-1),o(x(`textarea`,{"onUpdate:modelValue":d[8]||=e=>W.value.observaciones=e,rows:`2`,class:`field-input field-textarea`},null,512),[[u,W.value.observaciones]])]),V.value?(C(),_(`div`,Ne,p(V.value),1)):b(``,!0)]),x(`div`,Pe,[y(e,{variant:`text`,onClick:d[9]||=e=>z.value=!1},{default:v(()=>[...d[25]||=[m(`Cancelar`,-1)]]),_:1}),y(e,{color:`success`,variant:`flat`,loading:L.value,onClick:Le},{default:v(()=>[m(p(B.value?`Guardar Cambios`:`Crear Lote`),1)]),_:1},8,[`loading`])])]),_:1})]),_:1},8,[`modelValue`])])]),_:1}))}},[[`__scopeId`,`data-v-39f8bf23`]]);export{k as default};