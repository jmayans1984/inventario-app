...
<div class="lbl">
  ...
  <div class="lbl-header-bar">
    ...
    <div class="lot-ref">LOT<br>${e.codigo}</div>
  </div>

  ${e.peso_neto_oz||e.peso_neto_g||e.porciones||e.tamano_porcion?`
  <div class="weight-line">
    ${[e.peso_neto_oz?`${e.peso_neto_oz} oz`:``,e.peso_neto_g?`${e.peso_neto_g} g`:``,e.porciones?`${e.porciones} porciones`:``,e.tamano_porcion?`${e.tamano_porcion}`:``].filter(Boolean).join(` &middot; `)}
  </div>`:``}

  <div class="two-col">
    <div class="col">
      <div class="col-title">Fabricado</div>
      <div class="col-row"><span class="col-lbl">Fecha:</span><span class="col-val">${n(e.fecha_fab)}</span></div>
      ${e.responsable?`<div class="col-row"><span class="col-lbl">Resp:</span><span class="col-val">${e.responsable}</span></div>`:``}
    </div>
    <div class="col">
      <div class="col-title">Vence</div>
      <div class="col-row"><span class="col-lbl">Fecha:</span><span class="col-val">${n(e.fecha_vence)}</span></div>
      ${Q(e.fecha_vence)?`<div class="col-warn">Próximo</div>`:``}
    </div>
  </div>
