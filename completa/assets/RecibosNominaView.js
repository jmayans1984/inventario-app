import{n as e}from"./logo.js";import{t,v as n}from"./VBtn.js";import{t as r}from"./MainLayout.js";import{An as i,Gt as a,Kn as o,Ln as s,Xt as c,Yn as l,an as u,en as d,gn as ee,i as te,in as f,kn as p,nn as m,on as h,rn as g,s as ne,tn as _,xn as v,yn as y}from"./index.js";import{t as b}from"./VIcon.js";import{t as re}from"./PageHeader.js";var ie={class:`nom-wrap`},ae=[`value`],oe={key:0,class:`nom-card`,style:{padding:`32px`,"text-align":`center`}},se={key:1,class:`recibos-grid`},ce={class:`rec-header-container`},le={class:`rec-header`},ue={class:`rec-empresa`},de={class:`rec-periodo`},fe={class:`rec-emp-row`},pe={class:`rec-emp-nombre`},x={class:`rec-emp-tipo`},S={class:`rec-neto-big`},C={class:`rec-table`},w={key:0},T={class:`ta-r`},E={class:`ta-r`},D={class:`ta-r`},O={key:1},k={class:`ta-r`},A={class:`ta-r`},j={class:`ta-r`},M={key:2},N={class:`ta-r`},P={class:`rec-total-row`},F={class:`ta-r`},I={class:`rec-table`},L={key:0},R={class:`ta-r`},z={key:1},B={class:`ta-r`},me={key:2},he={class:`ta-r`},ge={key:3},_e={class:`ta-r`},ve={key:4},ye={class:`ta-r`},V={key:5},be={class:`ta-r`},xe={class:`rec-total-row`},Se={class:`ta-r`,style:{color:`var(--error)`}},Ce={class:`rec-table`,style:{opacity:`0.55`,"font-size":`10px`}},we={class:`ta-r`},Te={class:`ta-r`},Ee={key:0},De={class:`ta-r`},Oe={key:1},ke={class:`ta-r`},Ae={class:`rec-net-footer`},je={class:`rec-ytd-val`},Me={class:`rec-net-amount`},Ne={key:2,class:`nom-card estado-vacio`},Pe={key:3,class:`nom-card estado-vacio`},H=te({__name:`RecibosNominaView`,setup(te){let H=ne(),Fe=d(()=>H.empresa||H.user?.empresa||localStorage.getItem(`empresaActual`)||``),U=d(()=>H.empresaNombre||H.user?.empresaNombre||`Mi Empresa`),W=s([]),G=s(``),K=s(null),q=s([]),J=s(!1);function Y(e){if(!e)return`—`;try{let t;t=e instanceof Date?`${e.getUTCFullYear()}-${String(e.getUTCMonth()+1).padStart(2,`0`)}-${String(e.getUTCDate()).padStart(2,`0`)}`:String(e).split(`T`)[0];let[n,r,i]=t.split(`-`);return`${r}/${i}/${n}`}catch{return String(e)}}function X(e){return`$`+parseFloat(e||0).toLocaleString(`en-US`,{minimumFractionDigits:2,maximumFractionDigits:2})}function Z(e){return parseFloat(e||0).toFixed(2)}function Q(e){return e.tipo_empleado===`1099`&&e.empresa_contratista?`${e.apellido}, ${e.nombre} — ${e.empresa_contratista}`:`${e.apellido}, ${e.nombre}`}async function Ie(){try{W.value=(await e.get(`/nomina/liquidaciones`,{params:{empresa:Fe.value}})).data?.data||[],W.value.length&&(G.value=W.value[0].id,await $())}catch(e){console.error(`Error cargando liquidaciones:`,e)}}async function $(){if(!G.value){K.value=null,q.value=[];return}J.value=!0;try{let t=await e.get(`/nomina/liquidaciones/${G.value}`);K.value=t.data.liquidacion,q.value=t.data.lineas||[]}catch(e){console.error(`Error cargando líneas:`,e),K.value=null,q.value=[]}finally{J.value=!1}}function Le(e){if(!K.value)return;let t=window.open(``,`_blank`);if(!t){alert(`Activa los pop-ups para imprimir el recibo`);return}let n=`${Y(K.value.semana_inicio)} — ${Y(K.value.semana_fin)}`,r=U.value,i=Q(e),a=e.tipo_empleado===`W2`,o=`<span class="rec-badge ${a?`badge-w2`:`badge-1099`}">${e.tipo_empleado}</span>`,s=a?`Employee`:`Independent Contractor`,c=``;parseFloat(e.horas_regulares)>0&&(c+=`
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    </div>`}).join(``)}</div></body></html>`;e.document.write(r),e.document.close(),e.focus()}return ee(Ie),(e,s)=>(y(),m(r,null,{default:p(()=>[_(`div`,ie,[h(re,{title:`Recibos de Pago — Pay Stubs`,description:K.value?`${Y(K.value.semana_inicio)} — ${Y(K.value.semana_fin)}`:``,crumbs:[`Nómina`,`Reportes`,`Recibos de Pago`]},{actions:p(()=>[K.value?(y(),f(`span`,{key:0,class:o([`estado-badge`,`estado-${K.value.estado?.toLowerCase()}`])},l(K.value.estado),3)):g(``,!0),i(_(`select`,{"onUpdate:modelValue":s[0]||=e=>G.value=e,class:`drw-select`,style:{width:`220px`},onChange:$},[s[1]||=_(`option`,{value:``},`— Seleccionar nómina —`,-1),(y(!0),f(c,null,v(W.value,e=>(y(),f(`option`,{key:e.id,value:e.id},l(Y(e.semana_inicio))+` · `+l(e.estado),9,ae))),128))],544),[[a,G.value]]),q.value.length?(y(),m(t,{key:1,size:`small`,color:`secondary`,variant:`flat`,onClick:Re},{default:p(()=>[h(b,{size:`14`,class:`mr-1`},{default:p(()=>[...s[2]||=[u(`mdi-printer`,-1)]]),_:1}),s[3]||=u(` Imprimir Todos `,-1)]),_:1})):g(``,!0)]),_:1},8,[`description`]),J.value?(y(),f(`div`,oe,[h(n,{indeterminate:``,color:`secondary`,size:`28`})])):K.value&&q.value.length?(y(),f(`div`,se,[(y(!0),f(c,null,v(q.value,e=>(y(),f(`div`,{key:e.id,class:`recibo`},[_(`div`,ce,[_(`div`,le,[_(`div`,ue,l(U.value),1),s[4]||=_(`div`,{class:`rec-titulo`},`RECIBO DE PAGO`,-1),_(`div`,de,l(Y(K.value.semana_inicio))+` — `+l(Y(K.value.semana_fin)),1)]),h(t,{size:`x-small`,icon:`mdi-printer`,color:`white`,variant:`text`,onClick:t=>Le(e),class:`rec-print-btn`,title:`Imprimir este recibo`},null,8,[`onClick`])]),_(`div`,fe,[_(`div`,null,[_(`div`,pe,l(Q(e)),1),_(`div`,x,[_(`span`,{class:o([`rec-badge`,e.tipo_empleado===`W2`?`badge-w2`:`badge-1099`])},l(e.tipo_empleado),3),u(` `+l(e.tipo_empleado===`W2`?`Employee`:`Independent Contractor`),1)])]),_(`div`,S,[s[5]||=_(`div`,{style:{"font-size":`10px`,color:`rgba(255,255,255,0.5)`}},`NET PAY`,-1),_(`div`,null,l(X(e.total_neto)),1)])]),s[27]||=_(`div`,{class:`rec-section-title`},`EARNINGS`,-1),_(`table`,C,[s[11]||=_(`thead`,null,[_(`tr`,null,[_(`th`,null,`DESCRIPTION`),_(`th`,{class:`ta-r`},`HOURS`),_(`th`,{class:`ta-r`},`RATE`),_(`th`,{class:`ta-r`},`AMOUNT`)])],-1),_(`tbody`,null,[parseFloat(e.horas_regulares)>0?(y(),f(`tr`,w,[s[6]||=_(`td`,null,`Regular Pay`,-1),_(`td`,T,l(Z(e.horas_regulares)),1),_(`td`,E,l(X(e.valor_hora))+`/h`,1),_(`td`,D,l(X(e.bruto_regular)),1)])):g(``,!0),parseFloat(e.horas_overtime)>0?(y(),f(`tr`,O,[s[7]||=_(`td`,null,`Overtime Pay (1.5×)`,-1),_(`td`,k,l(Z(e.horas_overtime)),1),_(`td`,A,l(X(e.valor_hora_ot))+`/h`,1),_(`td`,j,l(X(e.bruto_overtime)),1)])):g(``,!0),parseFloat(e.bruto_base)>0?(y(),f(`tr`,M,[_(`td`,null,l(e.es_monto_fijo?`Fixed Weekly Amount`:`Base Salary`),1),s[8]||=_(`td`,{class:`ta-r`},`—`,-1),s[9]||=_(`td`,{class:`ta-r`},`—`,-1),_(`td`,N,l(X(e.bruto_base)),1)])):g(``,!0),_(`tr`,P,[s[10]||=_(`td`,{colspan:`3`},[_(`strong`,null,`Gross Pay`)],-1),_(`td`,F,[_(`strong`,null,l(X(e.total_bruto)),1)])])])]),e.tipo_empleado===`W2`?(y(),f(c,{key:0},[s[23]||=_(`div`,{class:`rec-section-title`},`DEDUCTIONS`,-1),_(`table`,I,[_(`tbody`,null,[parseFloat(e.federal_income_tax)>0?(y(),f(`tr`,L,[s[12]||=_(`td`,null,`Federal Income Tax (FIT)`,-1),_(`td`,R,`-`+l(X(e.federal_income_tax)),1)])):g(``,!0),parseFloat(e.social_security_emp)>0?(y(),f(`tr`,z,[s[13]||=_(`td`,null,`Social Security (6.2%)`,-1),_(`td`,B,`-`+l(X(e.social_security_emp)),1)])):g(``,!0),parseFloat(e.medicare_emp)>0?(y(),f(`tr`,me,[s[14]||=_(`td`,null,`Medicare (1.45%)`,-1),_(`td`,he,`-`+l(X(e.medicare_emp)),1)])):g(``,!0),parseFloat(e.medicare_adicional)>0?(y(),f(`tr`,ge,[s[15]||=_(`td`,null,`Additional Medicare (0.9%)`,-1),_(`td`,_e,`-`+l(X(e.medicare_adicional)),1)])):g(``,!0),parseFloat(e.workers_comp)>0?(y(),f(`tr`,ve,[s[16]||=_(`td`,null,`Workers' Compensation`,-1),_(`td`,ye,`-`+l(X(e.workers_comp)),1)])):g(``,!0),parseFloat(e.otras_deducciones)>0?(y(),f(`tr`,V,[s[17]||=_(`td`,null,`Other Deductions`,-1),_(`td`,be,`-`+l(X(e.otras_deducciones)),1)])):g(``,!0),_(`tr`,xe,[s[18]||=_(`td`,null,[_(`strong`,null,`Total Deductions`)],-1),_(`td`,Se,[_(`strong`,null,`-`+l(X(e.total_deducciones)),1)])])])]),s[24]||=_(`div`,{class:`rec-section-title`,style:{opacity:`0.5`}},`EMPLOYER CONTRIBUTIONS (informativo)`,-1),_(`table`,Ce,[_(`tbody`,null,[_(`tr`,null,[s[19]||=_(`td`,null,`Social Security (employer 6.2%)`,-1),_(`td`,we,l(X(e.social_security_er)),1)]),_(`tr`,null,[s[20]||=_(`td`,null,`Medicare (employer 1.45%)`,-1),_(`td`,Te,l(X(e.medicare_er)),1)]),parseFloat(e.futa)>0?(y(),f(`tr`,Ee,[s[21]||=_(`td`,null,`FUTA`,-1),_(`td`,De,l(X(e.futa)),1)])):g(``,!0),parseFloat(e.suta)>0?(y(),f(`tr`,Oe,[s[22]||=_(`td`,null,`FL Reemployment Tax`,-1),_(`td`,ke,l(X(e.suta)),1)])):g(``,!0)])])],64)):g(``,!0),_(`div`,Ae,[_(`div`,null,[s[25]||=_(`div`,{class:`rec-ytd-label`},`YTD Gross`,-1),_(`div`,je,l(X(e.ytd_bruto)),1)]),_(`div`,Me,[s[26]||=_(`div`,{style:{"font-size":`10px`,opacity:`0.7`}},`NET PAY`,-1),_(`div`,null,l(X(e.total_neto)),1)])])]))),128))])):G.value&&!J.value?(y(),f(`div`,Ne,[h(b,{size:`40`,color:`rgba(var(--v-theme-on-surface),0.15)`},{default:p(()=>[...s[28]||=[u(`mdi-file-document-outline`,-1)]]),_:1}),s[29]||=_(`div`,{style:{"margin-top":`10px`,"font-weight":`700`}},`Sin líneas de nómina`,-1),s[30]||=_(`div`,{style:{"font-size":`12px`,color:`rgba(var(--v-theme-on-surface),0.4)`,"margin-top":`4px`}},` Esta nómina no tiene recibos calculados. Calcula la nómina primero. `,-1)])):G.value?g(``,!0):(y(),f(`div`,Pe,[h(b,{size:`40`,color:`rgba(var(--v-theme-on-surface),0.15)`},{default:p(()=>[...s[31]||=[u(`mdi-cash-register`,-1)]]),_:1}),s[32]||=_(`div`,{style:{"margin-top":`10px`,"font-weight":`700`}},`Selecciona una nómina`,-1),s[33]||=_(`div`,{style:{"font-size":`12px`,color:`rgba(var(--v-theme-on-surface),0.4)`,"margin-top":`4px`}},` Elige una nómina aprobada del selector para ver los recibos de pago. `,-1)]))])]),_:1}))}},[[`__scopeId`,`data-v-fa9f8392`]]);export{H as default};