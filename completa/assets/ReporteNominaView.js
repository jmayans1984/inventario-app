import{p as e,t}from"./VBtn.js";import{o as n,t as r}from"./MainLayout.js";import{Jn as i,Kn as a,Ln as o,Xt as s,Yn as c,an as l,c as u,en as d,gn as f,i as p,in as m,kn as h,nn as g,on as _,rn as v,s as y,tn as b,xn as x,yn as S}from"./index.js";import{t as C}from"./VIcon.js";import{t as w}from"./VTextField.js";import{t as ee}from"./PageHeader.js";import{t as T}from"./KpiCard.js";var te={class:`rn-container`},ne={class:`rn-filters-card`},re={class:`rn-filters-row`},ie={class:`filter-group`},ae={class:`filter-group`},oe={key:1,class:`kpi-grid`},se={key:2,class:`rn-tabs-card`},ce={class:`rn-tabs-header`},le=[`onClick`],ue={key:0,class:`rn-empty`},de={key:1,class:`rn-table-wrap`},fe={class:`rn-table`},pe={class:`periodo-label`},me={class:`periodo-sub`},he={class:`ta-r`},ge={class:`ta-r font-mono`},E={class:`ta-r font-mono text-error`},D={class:`ta-r font-mono text-warning`},O={class:`ta-r font-mono text-success`},k={class:`ta-r font-mono text-purple`},A={class:`rn-tfoot`},j={class:`ta-r`},M={class:`ta-r font-mono`},N={class:`ta-r font-mono text-error`},P={class:`ta-r font-mono text-warning`},F={class:`ta-r font-mono text-success`},I={class:`ta-r font-mono text-purple`},L={key:2,class:`rn-table-wrap`},_e={class:`rn-table`},ve={class:`font-weight-medium`},ye={class:`ta-c`},be={class:`ta-r`},xe={class:`ta-r font-mono`},Se={class:`ta-r font-mono`},Ce={class:`ta-r font-mono`},we={class:`ta-r font-mono text-error`},Te={class:`ta-r font-mono text-warning`},Ee={class:`ta-r font-mono text-success`},De={class:`ta-r font-mono text-purple`},Oe={class:`rn-tfoot`},ke={class:`ta-r font-mono`},Ae={class:`ta-r font-mono text-error`},je={class:`ta-r font-mono text-warning`},Me={class:`ta-r font-mono text-success`},Ne={class:`ta-r font-mono text-purple`},Pe={key:3,class:`rn-table-wrap`},Fe={class:`rn-table`},Ie={class:`font-weight-medium`},Le={class:`ta-c text-caption font-mono`,style:{color:`rgba(var(--v-theme-on-surface),.5)`}},Re={class:`ta-r`},ze={class:`ta-r font-mono`},Be={class:`ta-r font-mono`},Ve={class:`ta-r font-mono text-purple`},He={class:`ta-r`},Ue={class:`pct-bar-wrap`},R={class:`pct-label`},We={class:`rn-tfoot`},Ge={class:`ta-r font-mono`},Ke={class:`ta-r font-mono text-purple`},qe={key:4,class:`rn-table-wrap`},Je={class:`rn-table`},Ye={class:`periodo-label`},Xe={class:`periodo-sub`},Ze={class:`ta-r font-mono`},Qe={class:`ta-r font-mono`},$e={class:`ta-r font-mono`},et={class:`ta-r font-mono`},tt={class:`ta-r font-mono`},nt={class:`ta-r font-mono`},rt={class:`ta-r font-mono`},it={class:`ta-r font-mono`},at={class:`ta-r font-mono text-error font-weight-bold`},ot={class:`rn-tfoot`},st={class:`ta-r font-mono`},ct={class:`ta-r font-mono`},lt={class:`ta-r font-mono`},ut={class:`ta-r font-mono`},dt={class:`ta-r font-mono`},ft={class:`ta-r font-mono`},pt={class:`ta-r font-mono`},mt={class:`ta-r font-mono`},ht={class:`ta-r font-mono text-error font-weight-bold`},z=p({__name:`ReporteNominaView`,setup(p){let z=y(),B=()=>z.empresaCodigo||z.empresa||localStorage.getItem(`empresaActual`),V=o(!1),H=o(!1),U=o(null),W=o([]),G=o(`periodo`);o({periodo:[],empleado:[],ccosto:[],impuestos:[]});let K=new Date().getFullYear(),q=o({fechaInicio:`${K}-01-01`,fechaFin:`${K}-12-31`}),gt=[{val:`periodo`,label:`Por Período`,icon:`mdi-calendar-range-outline`},{val:`empleado`,label:`Por Empleado`,icon:`mdi-account-group-outline`},{val:`ccosto`,label:`Por Centro de Costo`,icon:`mdi-sitemap-outline`},{val:`impuestos`,label:`Impuestos y Taxes`,icon:`mdi-receipt-text-outline`}],_t=d(()=>W.value.reduce((e,t)=>e+parseFloat(t.costo_bruto||0),0)),J=d(()=>W.value.reduce((e,t)=>e+parseFloat(t.costo_total||0),0));function Y(e){let t=J.value;return t>0?parseFloat(e)/t*100:0}async function X(){V.value=!0;try{let e=B(),t=new URLSearchParams({empresa:e,fechaInicio:q.value.fechaInicio,fechaFin:q.value.fechaFin,vista:G.value}),n=await(await fetch(`${u}/nomina/reporte?${t}`)).json();if(!n.success)throw Error(n.error);U.value=n.kpis,W.value=n.data||[]}catch(e){console.error(e)}finally{V.value=!1}}async function vt(e){G.value=e,await X()}function Z(e){return`$`+(parseFloat(e)||0).toLocaleString(`en-US`,{minimumFractionDigits:2,maximumFractionDigits:2})}function Q(e){return(parseFloat(e)||0).toLocaleString(`en-US`,{minimumFractionDigits:2,maximumFractionDigits:2})}function $(e){if(!e)return`—`;let[t,n,r]=String(e).split(`T`)[0].split(`-`);return`${n}/${r}/${t}`}async function yt(){if(U.value){H.value=!0;try{let e={empresa:B(),fechaInicio:q.value.fechaInicio,fechaFin:q.value.fechaFin},[t,n,r,i]=await Promise.all([fetch(`${u}/nomina/reporte?${new URLSearchParams({...e,vista:`periodo`})}`).then(e=>e.json()),fetch(`${u}/nomina/reporte?${new URLSearchParams({...e,vista:`empleado`})}`).then(e=>e.json()),fetch(`${u}/nomina/reporte?${new URLSearchParams({...e,vista:`ccosto`})}`).then(e=>e.json()),fetch(`${u}/nomina/reporte?${new URLSearchParams({...e,vista:`impuestos`})}`).then(e=>e.json())]),a=U.value,o=t.data||[],s=n.data||[],c=r.data||[],l=i.data||[],d=c.reduce((e,t)=>e+parseFloat(t.costo_bruto||0),0),f=c.reduce((e,t)=>e+parseFloat(t.costo_total||0),0);l.reduce((e,t)=>e+parseFloat(t.total_impuestos||0),0);let p=`
      ...
      * { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      <body>
        ...
        ${h}
        ${g}
      </body></html>`,y=window.open(``,`_blank`);if(!y){alert(`Activa los pop-ups para generar el PDF`);return}y.document.write(v),y.document.close(),y.focus()}catch(e){console.error(e)}finally{H.value=!1}}}return f(X),(o,u)=>(S(),g(r,null,{default:h(()=>[b(`div`,te,[_(ee,{title:`Reporte de Nómina`,description:`Análisis de costos por período, empleado, centro de costo e impuestos`,crumbs:[`Nómina`,`Reportes`,`Reporte de Nómina`]}),b(`div`,ne,[b(`div`,re,[b(`div`,ie,[u[2]||=b(`div`,{class:`filter-label`},`FECHA INICIO`,-1),_(w,{modelValue:q.value.fechaInicio,"onUpdate:modelValue":u[0]||=e=>q.value.fechaInicio=e,type:`date`,variant:`outlined`,density:`compact`,"hide-details":``,style:{"min-width":`160px`}},null,8,[`modelValue`])]),b(`div`,ae,[u[3]||=b(`div`,{class:`filter-label`},`FECHA FIN`,-1),_(w,{modelValue:q.value.fechaFin,"onUpdate:modelValue":u[1]||=e=>q.value.fechaFin=e,type:`date`,variant:`outlined`,density:`compact`,"hide-details":``,style:{"min-width":`160px`}},null,8,[`modelValue`])]),_(t,{color:`secondary`,variant:`flat`,rounded:`lg`,loading:V.value,onClick:X,height:`40`},{default:h(()=>[_(C,{start:``},{default:h(()=>[...u[4]||=[l(`mdi-magnify`,-1)]]),_:1}),u[5]||=l(`Generar Reporte `,-1)]),_:1},8,[`loading`]),_(n),U.value?(S(),g(t,{key:0,variant:`flat`,color:`secondary`,rounded:`lg`,height:`40`,loading:H.value,onClick:yt},{default:h(()=>[_(C,{start:``},{default:h(()=>[...u[6]||=[l(`mdi-file-pdf-box`,-1)]]),_:1}),u[7]||=l(`Exportar PDF `,-1)]),_:1},8,[`loading`])):v(``,!0)])]),V.value?(S(),g(e,{key:0,indeterminate:``,color:`secondary`,height:`3`,class:`mb-4`})):v(``,!0),U.value?(S(),m(`div`,oe,[_(T,{index:0,label:`Bruto Pagado`,value:Z(U.value.total_bruto),icon:`mdi-cash-multiple`,color:`var(--indigo)`},null,8,[`value`]),_(T,{index:1,label:`Deducciones Emp.`,value:Z(U.value.total_deducciones),icon:`mdi-minus-circle-outline`,color:`var(--error)`,"value-color":`var(--error)`},null,8,[`value`]),_(T,{index:2,label:`Neto Pagado`,value:Z(U.value.total_neto),icon:`mdi-bank-transfer-out`,color:`var(--success)`,"value-color":`var(--success)`},null,8,[`value`]),_(T,{index:3,label:`Aportes Empleador`,value:Z(U.value.total_aportes_er),icon:`mdi-office-building-outline`,color:`var(--gold)`,"value-color":`var(--gold)`},null,8,[`value`]),_(T,{index:4,label:`Costo Total Empresa`,value:Z(U.value.costo_total_empresa),icon:`mdi-domain`,color:`var(--indigo)`,"value-color":`var(--indigo)`},null,8,[`value`]),_(T,{index:5,label:`Nóminas / Empleados`,value:`${U.value.total_nominas} / ${U.value.total_empleados}`,icon:`mdi-account-group-outline`,color:`var(--indigo)`,"value-color":`var(--indigo)`},null,8,[`value`])])):v(``,!0),U.value||W.value.length?(S(),m(`div`,se,[b(`div`,ce,[(S(),m(s,null,x(gt,e=>b(`button`,{key:e.val,class:a([`rn-tab`,{"rn-tab--active":G.value===e.val}]),onClick:t=>vt(e.val)},[_(C,{size:`15`,class:`mr-1`},{default:h(()=>[l(c(e.icon),1)]),_:2},1024),l(c(e.label),1)],10,le)),64))]),!V.value&&W.value.length===0?(S(),m(`div`,ue,[_(C,{size:`40`,color:`rgba(var(--v-theme-on-surface),.15)`,class:`mb-2`},{default:h(()=>[...u[8]||=[l(`mdi-file-search-outline`,-1)]]),_:1}),u[9]||=b(`div`,null,`No hay nóminas aprobadas en el período seleccionado`,-1)])):G.value===`periodo`&&W.value.length?(S(),m(`div`,de,[b(`table`,fe,[u[11]||=b(`thead`,null,[b(`tr`,null,[b(`th`,null,`PERÍODO`),b(`th`,{class:`ta-r`},`EMPLEADOS`),b(`th`,{class:`ta-r`},`BRUTO`),b(`th`,{class:`ta-r`},`DEDUCCIONES`),b(`th`,{class:`ta-r`},`APORTES ER`),b(`th`,{class:`ta-r`},`NETO`),b(`th`,{class:`ta-r`},`COSTO EMPRESA`)])],-1),b(`tbody`,null,[(S(!0),m(s,null,x(W.value,e=>(S(),m(`tr`,{key:e.id},[b(`td`,null,[b(`div`,pe,c($(e.semana_inicio)),1),b(`div`,me,`al `+c($(e.semana_fin)),1)]),b(`td`,he,c(e.empleados),1),b(`td`,ge,c(Z(e.total_bruto)),1),b(`td`,E,c(Z(e.total_deducciones)),1),b(`td`,D,c(Z(e.total_aportes_er)),1),b(`td`,O,c(Z(e.total_neto)),1),b(`td`,k,c(Z(e.costo_empresa)),1)]))),128))]),b(`tfoot`,null,[b(`tr`,A,[u[10]||=b(`td`,null,[b(`strong`,null,`TOTAL`)],-1),b(`td`,j,c(U.value.total_empleados),1),b(`td`,M,c(Z(U.value.total_bruto)),1),b(`td`,N,c(Z(U.value.total_deducciones)),1),b(`td`,P,c(Z(U.value.total_aportes_er)),1),b(`td`,F,c(Z(U.value.total_neto)),1),b(`td`,I,c(Z(U.value.costo_total_empresa)),1)])])])])):G.value===`empleado`&&W.value.length?(S(),m(`div`,L,[b(`table`,_e,[u[13]||=b(`thead`,null,[b(`tr`,null,[b(`th`,null,`EMPLEADO`),b(`th`,{class:`ta-c`},`TIPO`),b(`th`,{class:`ta-r`},`NÓMINAS`),b(`th`,{class:`ta-r`},`HRS REG`),b(`th`,{class:`ta-r`},`HRS OT`),b(`th`,{class:`ta-r`},`BRUTO`),b(`th`,{class:`ta-r`},`DEDUCCIONES`),b(`th`,{class:`ta-r`},`APORTES ER`),b(`th`,{class:`ta-r`},`NETO`),b(`th`,{class:`ta-r`},`COSTO EMP.`)])],-1),b(`tbody`,null,[(S(!0),m(s,null,x(W.value,e=>(S(),m(`tr`,{key:e.empleado_id},[b(`td`,ve,c(e.nombre),1),b(`td`,ye,[b(`span`,{class:a(e.tipo_empleado===`W2`?`badge-w2`:`badge-1099`)},c(e.tipo_empleado),3)]),b(`td`,be,c(e.total_nominas),1),b(`td`,xe,c(Q(e.horas_regulares)),1),b(`td`,Se,c(Q(e.horas_overtime)),1),b(`td`,Ce,c(Z(e.total_bruto)),1),b(`td`,we,c(Z(e.total_deducciones)),1),b(`td`,Te,c(Z(e.total_aportes_er)),1),b(`td`,Ee,c(Z(e.total_neto)),1),b(`td`,De,c(Z(e.costo_empresa)),1)]))),128))]),b(`tfoot`,null,[b(`tr`,Oe,[u[12]||=b(`td`,{colspan:`5`},[b(`strong`,null,`TOTAL`)],-1),b(`td`,ke,c(Z(U.value.total_bruto)),1),b(`td`,Ae,c(Z(U.value.total_deducciones)),1),b(`td`,je,c(Z(U.value.total_aportes_er)),1),b(`td`,Me,c(Z(U.value.total_neto)),1),b(`td`,Ne,c(Z(U.value.costo_total_empresa)),1)])])])])):G.value===`ccosto`&&W.value.length?(S(),m(`div`,Pe,[b(`table`,Fe,[u[16]||=b(`thead`,null,[b(`tr`,null,[b(`th`,null,`CENTRO DE COSTO`),b(`th`,{class:`ta-c`},`CÓD.`),b(`th`,{class:`ta-r`},`EMPLEADOS`),b(`th`,{class:`ta-r`},`HORAS`),b(`th`,{class:`ta-r`},`COSTO BRUTO`),b(`th`,{class:`ta-r`},`COSTO TOTAL`),b(`th`,{class:`ta-r`},`% DEL TOTAL`)])],-1),b(`tbody`,null,[(S(!0),m(s,null,x(W.value,e=>(S(),m(`tr`,{key:e.ccosto},[b(`td`,Ie,c(e.ccosto_nombre),1),b(`td`,Le,c(e.ccosto),1),b(`td`,Re,c(e.empleados),1),b(`td`,ze,c(Q(e.horas)),1),b(`td`,Be,c(Z(e.costo_bruto)),1),b(`td`,Ve,c(Z(e.costo_total)),1),b(`td`,He,[b(`div`,Ue,[b(`div`,{class:`pct-bar`,style:i({width:Y(e.costo_total)+`%`})},null,4),b(`span`,R,c(Y(e.costo_total).toFixed(1))+`%`,1)])])]))),128))]),b(`tfoot`,null,[b(`tr`,We,[u[14]||=b(`td`,{colspan:`4`},[b(`strong`,null,`TOTAL`)],-1),b(`td`,Ge,c(Z(_t.value)),1),b(`td`,Ke,c(Z(J.value)),1),u[15]||=b(`td`,{class:`ta-r`},`100%`,-1)])])])])):G.value===`impuestos`&&W.value.length?(S(),m(`div`,qe,[b(`table`,Je,[u[18]||=b(`thead`,null,[b(`tr`,null,[b(`th`,null,`PERÍODO`),b(`th`,{class:`ta-r`},`FED. INC. TAX`),b(`th`,{class:`ta-r`},`SS EMP.`),b(`th`,{class:`ta-r`},`SS ER`),b(`th`,{class:`ta-r`},`MEDICARE EMP.`),b(`th`,{class:`ta-r`},`MEDICARE ER`),b(`th`,{class:`ta-r`},`FUTA`),b(`th`,{class:`ta-r`},`SUTA`),b(`th`,{class:`ta-r`},`W.COMP`),b(`th`,{class:`ta-r text-error`},`TOTAL IMP.`)])],-1),b(`tbody`,null,[(S(!0),m(s,null,x(W.value,e=>(S(),m(`tr`,{key:e.semana_inicio},[b(`td`,null,[b(`div`,Ye,c($(e.semana_inicio)),1),b(`div`,Xe,`al `+c($(e.semana_fin)),1)]),b(`td`,Ze,c(Z(e.federal_income_tax)),1),b(`td`,Qe,c(Z(e.ss_emp)),1),b(`td`,$e,c(Z(e.ss_er)),1),b(`td`,et,c(Z(e.medicare_emp)),1),b(`td`,tt,c(Z(e.medicare_er)),1),b(`td`,nt,c(Z(e.futa)),1),b(`td`,rt,c(Z(e.suta)),1),b(`td`,it,c(Z(e.workers_comp)),1),b(`td`,at,c(Z(e.total_impuestos)),1)]))),128))]),b(`tfoot`,null,[b(`tr`,ot,[u[17]||=b(`td`,null,[b(`strong`,null,`TOTAL`)],-1),b(`td`,st,c(Z(U.value.federal_income_tax)),1),b(`td`,ct,c(Z(U.value.social_security_emp)),1),b(`td`,lt,c(Z(U.value.social_security_er)),1),b(`td`,ut,c(Z(U.value.medicare_emp)),1),b(`td`,dt,c(Z(U.value.medicare_er)),1),b(`td`,ft,c(Z(U.value.futa)),1),b(`td`,pt,c(Z(U.value.suta)),1),b(`td`,mt,c(Z(U.value.workers_comp)),1),b(`td`,ht,c(Z(+U.value.federal_income_tax+ +U.value.social_security_emp+ +U.value.social_security_er+ +U.value.medicare_emp+ +U.value.medicare_er+ +U.value.futa+ +U.value.suta+ +U.value.workers_comp)),1)])])])])):v(``,!0)])):v(``,!0)])]),_:1}))}},[[`__scopeId`,`data-v-5169365b`]]);export{z as default};