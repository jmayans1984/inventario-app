import{g as e,t}from"./VBtn-DJagkhZL.js";import{$t as n,En as r,Gn as i,Hn as a,Kt as o,Nn as s,Qt as c,Tn as l,Vt as u,Xt as d,Zt as f,_n as p,a as ee,en as m,fn as te,hn as h,nn as g,tn as _}from"./index-DHhlsRu3.js";import{t as v}from"./api-98cPg_w6.js";import{t as ne}from"./MainLayout-BMvVuYZO.js";import{c as re,t as y}from"./VIcon-CE7gZCMW.js";var ie={class:`nom-wrap`},ae={class:`nom-header`},oe={class:`nom-header-icon`},se={class:`flex-1`},ce={key:0,class:`nom-sub`},le={style:{display:`flex`,gap:`8px`,"align-items":`center`,"flex-wrap":`wrap`}},ue=[`value`],de={key:0,class:`nom-card`,style:{padding:`32px`,"text-align":`center`}},fe={key:1,class:`recibos-grid`},pe={class:`rec-header-container`},b={class:`rec-header`},x={class:`rec-empresa`},S={class:`rec-periodo`},C={class:`rec-emp-row`},w={class:`rec-emp-nombre`},T={class:`rec-emp-tipo`},E={class:`rec-neto-big`},D={class:`rec-table`},O={key:0},k={class:`ta-r`},A={class:`ta-r`},j={class:`ta-r`},M={key:1},N={class:`ta-r`},P={class:`ta-r`},F={class:`ta-r`},I={key:2},L={class:`ta-r`},R={class:`rec-total-row`},z={class:`ta-r`},B={class:`rec-table`},me={key:0},he={class:`ta-r`},ge={key:1},_e={class:`ta-r`},ve={key:2},ye={class:`ta-r`},be={key:3},xe={class:`ta-r`},Se={key:4},V={class:`ta-r`},Ce={key:5},we={class:`ta-r`},Te={class:`rec-total-row`},Ee={class:`ta-r`,style:{color:`#ef4444`}},De={class:`rec-table`,style:{opacity:`0.55`,"font-size":`10px`}},Oe={class:`ta-r`},ke={class:`ta-r`},Ae={key:0},je={class:`ta-r`},Me={key:1},Ne={class:`ta-r`},Pe={class:`rec-net-footer`},Fe={class:`rec-ytd-val`},Ie={class:`rec-net-amount`},Le={key:2,class:`nom-card estado-vacio`},Re={key:3,class:`nom-card estado-vacio`},H=re({__name:`RecibosNominaView`,setup(re){let H=ee(),ze=d(()=>H.empresa||H.user?.empresa||localStorage.getItem(`empresaActual`)||``),U=d(()=>H.empresaNombre||H.user?.empresaNombre||`Mi Empresa`),W=s([]),G=s(``),K=s(null),q=s([]),J=s(!1);function Y(e){if(!e)return`—`;try{let t;t=e instanceof Date?`${e.getUTCFullYear()}-${String(e.getUTCMonth()+1).padStart(2,`0`)}-${String(e.getUTCDate()).padStart(2,`0`)}`:String(e).split(`T`)[0];let[n,r,i]=t.split(`-`);return`${parseInt(i)} ${[``,`Ene`,`Feb`,`Mar`,`Abr`,`May`,`Jun`,`Jul`,`Ago`,`Sep`,`Oct`,`Nov`,`Dic`][parseInt(r)]} ${n}`}catch{return String(e)}}function X(e){return`$`+parseFloat(e||0).toLocaleString(`en-US`,{minimumFractionDigits:2,maximumFractionDigits:2})}function Z(e){return parseFloat(e||0).toFixed(2)}function Q(e){return e.tipo_empleado===`1099`&&e.empresa_contratista?`${e.apellido}, ${e.nombre} — ${e.empresa_contratista}`:`${e.apellido}, ${e.nombre}`}async function Be(){try{W.value=(await v.get(`/nomina/liquidaciones`,{params:{empresa:ze.value}})).data?.data||[],W.value.length&&(G.value=W.value[0].id,await $())}catch(e){console.error(`Error cargando liquidaciones:`,e)}}async function $(){if(!G.value){K.value=null,q.value=[];return}J.value=!0;try{let e=await v.get(`/nomina/liquidaciones/${G.value}`);K.value=e.data.liquidacion,q.value=e.data.lineas||[]}catch(e){console.error(`Error cargando líneas:`,e),K.value=null,q.value=[]}finally{J.value=!1}}function Ve(e){if(!K.value)return;let t=window.open(``,`_blank`);if(!t){alert(`Activa los pop-ups para imprimir el recibo`);return}let n=`${Y(K.value.semana_inicio)} — ${Y(K.value.semana_fin)}`,r=U.value,i=Q(e),a=e.tipo_empleado===`W2`,o=`<span class="rec-badge ${a?`badge-w2`:`badge-1099`}">${e.tipo_empleado}</span>`,s=a?`Employee`:`Independent Contractor`,c=``;parseFloat(e.horas_regulares)>0&&(c+=`
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    </div>`}).join(``)}</div></body></html>`;e.document.write(r),e.document.close(),e.focus()}return te(Be),(s,d)=>(h(),c(ne,null,{default:l(()=>[f(`div`,ie,[f(`div`,ae,[f(`div`,oe,[g(y,{size:`20`,color:`white`},{default:l(()=>[...d[1]||=[_(`mdi-file-document-outline`,-1)]]),_:1})]),f(`div`,se,[d[2]||=f(`h1`,{class:`nom-title`},`RECIBOS DE PAGO — PAY STUBS`,-1),K.value?(h(),m(`p`,ce,[_(i(Y(K.value.semana_inicio))+` — `+i(Y(K.value.semana_fin))+` `,1),f(`span`,{class:a([`estado-badge`,`estado-${K.value.estado?.toLowerCase()}`])},i(K.value.estado),3)])):n(``,!0)]),f(`div`,le,[r(f(`select`,{"onUpdate:modelValue":d[0]||=e=>G.value=e,class:`drw-select`,style:{width:`220px`},onChange:$},[d[3]||=f(`option`,{value:``},`— Seleccionar nómina —`,-1),(h(!0),m(o,null,p(W.value,e=>(h(),m(`option`,{key:e.id,value:e.id},i(Y(e.semana_inicio))+` · `+i(e.estado),9,ue))),128))],544),[[u,G.value]]),q.value.length?(h(),c(t,{key:0,size:`small`,color:`#8b5cf6`,variant:`flat`,onClick:He},{default:l(()=>[g(y,{size:`14`,class:`mr-1`},{default:l(()=>[...d[4]||=[_(`mdi-printer`,-1)]]),_:1}),d[5]||=_(` Imprimir Todos `,-1)]),_:1})):n(``,!0)])]),J.value?(h(),m(`div`,de,[g(e,{indeterminate:``,color:`#8b5cf6`,size:`28`})])):K.value&&q.value.length?(h(),m(`div`,fe,[(h(!0),m(o,null,p(q.value,e=>(h(),m(`div`,{key:e.id,class:`recibo`},[f(`div`,pe,[f(`div`,b,[f(`div`,x,i(U.value),1),d[6]||=f(`div`,{class:`rec-titulo`},`RECIBO DE PAGO`,-1),f(`div`,S,i(Y(K.value.semana_inicio))+` — `+i(Y(K.value.semana_fin)),1)]),g(t,{size:`x-small`,icon:`mdi-printer`,color:`white`,variant:`text`,onClick:t=>Ve(e),class:`rec-print-btn`,title:`Imprimir este recibo`},null,8,[`onClick`])]),f(`div`,C,[f(`div`,null,[f(`div`,w,i(Q(e)),1),f(`div`,T,[f(`span`,{class:a([`rec-badge`,e.tipo_empleado===`W2`?`badge-w2`:`badge-1099`])},i(e.tipo_empleado),3),_(` `+i(e.tipo_empleado===`W2`?`Employee`:`Independent Contractor`),1)])]),f(`div`,E,[d[7]||=f(`div`,{style:{"font-size":`10px`,color:`rgba(255,255,255,0.5)`}},`NET PAY`,-1),f(`div`,null,i(X(e.total_neto)),1)])]),d[29]||=f(`div`,{class:`rec-section-title`},`EARNINGS`,-1),f(`table`,D,[d[13]||=f(`thead`,null,[f(`tr`,null,[f(`th`,null,`DESCRIPTION`),f(`th`,{class:`ta-r`},`HOURS`),f(`th`,{class:`ta-r`},`RATE`),f(`th`,{class:`ta-r`},`AMOUNT`)])],-1),f(`tbody`,null,[parseFloat(e.horas_regulares)>0?(h(),m(`tr`,O,[d[8]||=f(`td`,null,`Regular Pay`,-1),f(`td`,k,i(Z(e.horas_regulares)),1),f(`td`,A,i(X(e.valor_hora))+`/h`,1),f(`td`,j,i(X(e.bruto_regular)),1)])):n(``,!0),parseFloat(e.horas_overtime)>0?(h(),m(`tr`,M,[d[9]||=f(`td`,null,`Overtime Pay (1.5×)`,-1),f(`td`,N,i(Z(e.horas_overtime)),1),f(`td`,P,i(X(e.valor_hora_ot))+`/h`,1),f(`td`,F,i(X(e.bruto_overtime)),1)])):n(``,!0),parseFloat(e.bruto_base)>0?(h(),m(`tr`,I,[f(`td`,null,i(e.es_monto_fijo?`Fixed Weekly Amount`:`Base Salary`),1),d[10]||=f(`td`,{class:`ta-r`},`—`,-1),d[11]||=f(`td`,{class:`ta-r`},`—`,-1),f(`td`,L,i(X(e.bruto_base)),1)])):n(``,!0),f(`tr`,R,[d[12]||=f(`td`,{colspan:`3`},[f(`strong`,null,`Gross Pay`)],-1),f(`td`,z,[f(`strong`,null,i(X(e.total_bruto)),1)])])])]),e.tipo_empleado===`W2`?(h(),m(o,{key:0},[d[25]||=f(`div`,{class:`rec-section-title`},`DEDUCTIONS`,-1),f(`table`,B,[f(`tbody`,null,[parseFloat(e.federal_income_tax)>0?(h(),m(`tr`,me,[d[14]||=f(`td`,null,`Federal Income Tax (FIT)`,-1),f(`td`,he,`-`+i(X(e.federal_income_tax)),1)])):n(``,!0),parseFloat(e.social_security_emp)>0?(h(),m(`tr`,ge,[d[15]||=f(`td`,null,`Social Security (6.2%)`,-1),f(`td`,_e,`-`+i(X(e.social_security_emp)),1)])):n(``,!0),parseFloat(e.medicare_emp)>0?(h(),m(`tr`,ve,[d[16]||=f(`td`,null,`Medicare (1.45%)`,-1),f(`td`,ye,`-`+i(X(e.medicare_emp)),1)])):n(``,!0),parseFloat(e.medicare_adicional)>0?(h(),m(`tr`,be,[d[17]||=f(`td`,null,`Additional Medicare (0.9%)`,-1),f(`td`,xe,`-`+i(X(e.medicare_adicional)),1)])):n(``,!0),parseFloat(e.workers_comp)>0?(h(),m(`tr`,Se,[d[18]||=f(`td`,null,`Workers' Compensation`,-1),f(`td`,V,`-`+i(X(e.workers_comp)),1)])):n(``,!0),parseFloat(e.otras_deducciones)>0?(h(),m(`tr`,Ce,[d[19]||=f(`td`,null,`Other Deductions`,-1),f(`td`,we,`-`+i(X(e.otras_deducciones)),1)])):n(``,!0),f(`tr`,Te,[d[20]||=f(`td`,null,[f(`strong`,null,`Total Deductions`)],-1),f(`td`,Ee,[f(`strong`,null,`-`+i(X(e.total_deducciones)),1)])])])]),d[26]||=f(`div`,{class:`rec-section-title`,style:{opacity:`0.5`}},`EMPLOYER CONTRIBUTIONS (informativo)`,-1),f(`table`,De,[f(`tbody`,null,[f(`tr`,null,[d[21]||=f(`td`,null,`Social Security (employer 6.2%)`,-1),f(`td`,Oe,i(X(e.social_security_er)),1)]),f(`tr`,null,[d[22]||=f(`td`,null,`Medicare (employer 1.45%)`,-1),f(`td`,ke,i(X(e.medicare_er)),1)]),parseFloat(e.futa)>0?(h(),m(`tr`,Ae,[d[23]||=f(`td`,null,`FUTA`,-1),f(`td`,je,i(X(e.futa)),1)])):n(``,!0),parseFloat(e.suta)>0?(h(),m(`tr`,Me,[d[24]||=f(`td`,null,`FL Reemployment Tax`,-1),f(`td`,Ne,i(X(e.suta)),1)])):n(``,!0)])])],64)):n(``,!0),f(`div`,Pe,[f(`div`,null,[d[27]||=f(`div`,{class:`rec-ytd-label`},`YTD Gross`,-1),f(`div`,Fe,i(X(e.ytd_bruto)),1)]),f(`div`,Ie,[d[28]||=f(`div`,{style:{"font-size":`10px`,opacity:`0.7`}},`NET PAY`,-1),f(`div`,null,i(X(e.total_neto)),1)])])]))),128))])):G.value&&!J.value?(h(),m(`div`,Le,[g(y,{size:`40`,color:`rgba(var(--v-theme-on-surface),0.15)`},{default:l(()=>[...d[30]||=[_(`mdi-file-document-outline`,-1)]]),_:1}),d[31]||=f(`div`,{style:{"margin-top":`10px`,"font-weight":`700`}},`Sin líneas de nómina`,-1),d[32]||=f(`div`,{style:{"font-size":`12px`,color:`rgba(var(--v-theme-on-surface),0.4)`,"margin-top":`4px`}},` Esta nómina no tiene recibos calculados. Calcula la nómina primero. `,-1)])):G.value?n(``,!0):(h(),m(`div`,Re,[g(y,{size:`40`,color:`rgba(var(--v-theme-on-surface),0.15)`},{default:l(()=>[...d[33]||=[_(`mdi-cash-register`,-1)]]),_:1}),d[34]||=f(`div`,{style:{"margin-top":`10px`,"font-weight":`700`}},`Selecciona una nómina`,-1),d[35]||=f(`div`,{style:{"font-size":`12px`,color:`rgba(var(--v-theme-on-surface),0.4)`,"margin-top":`4px`}},` Elige una nómina aprobada del selector para ver los recibos de pago. `,-1)]))])]),_:1}))}},[[`__scopeId`,`data-v-dde8d49f`]]);export{H as default};